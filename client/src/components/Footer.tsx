        ...
        <div className="footer-top-grid">
          ...
          <div className="footer-column">
            ...
            <div className="footer-col-links">
              ...
              <a href="https://github.com/Aryan0628/diffguardian/releases" target="_blank" rel="noopener noreferrer" className="footer-link" style={{ fontFamily: "var(--font-space-grotesk)" }}>Changelog</a>
            </div>
          </div>
          ...
          <div className="footer-column">
            ...
            <div className="footer-col-links">
              <a href="https://github.com/Aryan0628/diffguardian" target="_blank" rel="noopener noreferrer" className="footer-link" style={{ fontFamily: "var(--font-space-grotesk)" }}>GitHub Repository</a>
              <a href="https://github.com/Aryan0628/diffguardian/issues/new" target="_blank" rel="noopener noreferrer" className="footer-link" style={{ fontFamily: "var(--font-space-grotesk)" }}>Report a Bug</a>
              <a href="https://github.com/Aryan0628/diffguardian/issues/new" target="_blank" rel="noopener noreferrer" className="footer-link" style={{ fontFamily: "var(--font-space-grotesk)" }}>Request a Feature</a>
          ...
          <div className="footer-column">
            ...
            <div className="footer-col-links">
              ...
              <a href="https://npmjs.com/package/@aryan28/diff-guard" target="_blank" rel="noopener noreferrer" className="footer-link" style={{ fontFamily: "var(--font-space-grotesk)" }}>NPM Package</a>
            </div>
          </div>
